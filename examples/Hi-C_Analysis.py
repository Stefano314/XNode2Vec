...
#     plt.hist(Families( xn2v.similar_nodes(G, node_id, picked = 700, Weight = True, dim = 80, walk_length = walk_l, context = 5, p = p,
...
for node_id in range(0,55,2):
	...
	families.append(Families(xn2v.similar_nodes(G,node_id,picked=700,Weight=True,dim=80,walk_length=walk_l,context=5,p=p,q=q,workers=4,train_time=5),
                             0.4))
